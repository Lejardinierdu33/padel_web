...
// Définition du composant fonctionnel NavBarThird
      ...
      <div className="nav_section_all">
        <div className="navBarIntro">
          ...
          <div className="second_section_right">
            ...
            {/* Section de navigation avec le lien vers la page d'accueil */}
            ...
            {/* Section pour afficher le bouton de connexion avec le lien vers la page d'inscription */}
...
// Exportation du composant NavBarThird par défaut
