...
import { FaEye } from "react-icons/fa"; // Importation de l'icône d'œil pour afficher/masquer le mot de passe
import { accountService } from "../../../_services/account.service"; // Importation du service d'administration des comptes

// Définition du composant fonctionnel AUserAdd
export default function AUserAdd() {
